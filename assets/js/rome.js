  ...
  return (function e(t, n, r) {
  ...
  })(
    {
            ...
            function rangeToTextRange(p) {
              if (p.collapsed) {
                return createBoundaryTextRange(
                  { node: p.startContainer, offset: p.startOffset },
                  true
                );
              }
      ...
      11: [
        function (require, module, exports) {
          (function (global) {
            ...
            var doc = document;
            var ff =
              win.mozInnerScreenX !== null && win.mozInnerScreenX !== void 0;
        ...
        function (require, module, exports) {
          ...
          (function (global, factory) {
            ...
            function dayOfYearFromWeeks(
              ...
              dayOfYear =
                7 * (week - 1) + (weekday - firstDayOfWeek) + daysToAdd + 1;

              return {
                year: dayOfYear > 0 ? year : year - 1,
                dayOfYear:
                  dayOfYear > 0 ? dayOfYear : daysInYear(year - 1) + dayOfYear,
              };
            }
            ...
            function isDaylightSavingTimeShifted() {
              if (this._a) {
                ...
                return (
                  this.isValid() && compareArrays(this._a, other.toArray()) > 0
                );
              }
        ...
        function (require, module, exports) {
          ...
          function calendar(calendarOptions) {
            ...
            function changeMonth(op) {
              ...
              var offset =
                o.monthsInCalendar + direction * getMonthOffset(lastDayElement);
            ...
            function updateCalendarSelection() {
              ...
              function inside(child) {
                return (
                  !classes.contains(child, o.styles.dayPrevMonth) &&
            ...
            function pickDay(e) {
              ...
              var offset =
                getMonthOffset(target) - getMonthOffset(lastDayElement);
      ...
      25: [
        ...
        { "./index": 28, "./inline": 29, "./input": 30, "./isInput": 31 },
      ],
      26: [
        function (require, module, exports) {
          "use strict";
          ...
          function defaults(options, cal) {
            ...
            if (o.min && o.max) {
              ...
              if (o.date === true) {
                ...
                o.timeInterval * 1000 - (o.min % (o.timeInterval * 1000)) >
                o.max - o.min
              ) {
                throw new Error(
        ...
        { "./isInput": 31, "./momentum": 32, "./parse": 34 },
      ],
      27: [
        function (require, module, exports) {
          "use strict";
      ...
      31: [
        function (require, module, exports) {
          ...
          function isInput(elem) {
            return (
              elem && elem.nodeName && elem.nodeName.toLowerCase() === "input"
            );
          }
